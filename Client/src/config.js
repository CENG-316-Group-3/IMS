...
import StudentCoordinatorAnnouncementsPage from "./page_contents/student/CoordinatorAnnouncements";
import StudentCoordinatorAnAnnouncement from "./page_contents/student/StdCoordinatorAnnViewPage";
...
import NotificationsPage from "./page_contents/Notifications";
import NotificationPage from "./page_contents/Notification";
...
const site_map = [
    ...
    { role: "student", link: "/student_announcements", page_content: StudentCoordinatorAnnouncementsPage },
    { role: "student", link: "student_an_announcement/:id", page_content: StudentCoordinatorAnAnnouncement },
    ...
    // Other Routes //
    { role: "", link: "/application_letter/:id/:studentMail/:companyMail", page_content: ApplicationLetter },
    { role: "", link: "/application_form", page_content: ApplicationForm },
    { role: "", link: "/notifications", page_content: NotificationsPage },
    { role: "", link: "/notification/:id", page_content: NotificationPage },
...
const main_config = {
    company: {
        ...
        allowed_routes: generate_allowed_routes_with_site_map("company").concat(["/application_letter/:id/:studentMail/:companyMail", "/application_form", "/notifications", "/notification/:id"]),
    },
    student: {
        navbar_items: [
        ...
        allowed_routes: generate_allowed_routes_with_site_map("student").concat(["/application_letter/:id/:studentMail/:companyMail", "/application_form", "/notifications", "/notification/:id"]),
    },
    coordinator: {
        navbar_items: [
        ...
        allowed_routes: generate_allowed_routes_with_site_map("coordinator").concat(["/application_letter/:id/:studentMail/:companyMail", "/application_form/:id"]),
    },
    secretariat: {
        navbar_items: [
