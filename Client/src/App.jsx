...
import CompanyForgetPassword from "./pages/CompanyForgetPassword";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/company-forget-password" element={<ProtectedRoute cases={[default_login_register_protection_case]}><CompanyForgetPassword /></ProtectedRoute>} />
        <Route path="/company-reset-password" element={<ProtectedRoute cases={[default_login_register_protection_case]}><CompanyResetPassword /></ProtectedRoute>} />
